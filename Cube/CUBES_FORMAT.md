...
indexed `POS_NORMAL_UV_TANGENT` mesh. The source's six opaque world colours
...
bevel/noise treatment while retaining a visible cube boundary.

World 01 contains 15,024 decoded source cubes. Its joined artifact contains
27,388 exposed quads / 54,776 triangles in one retained draw, with 5,258,496
