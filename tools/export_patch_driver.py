...
def export(bake, output):
    ...
    assert [(urb[f'stage{i}_size'], urb[f'stage{i}_start'], urb[f'stage{i}_entries'])
            for i in range(4)] == [(1,4,2048),(2,20,896),(2,34,1920),(1,4,0)]
    ...
    text += f'pub(crate) const PALETTE_SHA256: &str = "{manifest["palette_sha256"]}";\n'
    text += 'pub(crate) const CONTRACT_VERSION: u32 = 10;\n'
...
pub(crate) const URB: [(u32,u32,u32); 4] = [(1,4,2048),(2,20,896),(2,34,1920),(1,4,0)];
