...
mod tests {
    ...
    fn worm_and_snake_publish_and_recover_independently() {
        ...
        let shared=Mutex::new(Shared {session:1,running:true,connected:true,world_id:1,empty_ready:false,structure:None,gallery_ready:None,vfx_ready:None,snake_ready:None,worm_ready:None,
